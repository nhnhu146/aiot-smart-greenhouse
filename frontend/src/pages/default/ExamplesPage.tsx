...
const ExamplesPage = () => {
	...
	const renderControlCard = (topic: any, index: number) => (
		<Col md={6} lg={4} key={index} className="mb-4">
			<Card className="h-100">
				<Card.Header className="d-flex justify-content-between align-items-center">
					<strong>{topic.name}</strong>
				...
				<Tab eventKey="mqtt-sensor" title="📊 MQTT Sensor Topics">
					<Card className="mb-4">
						...
						<Card.Body>
							...
							<Row>
								{sensorTopics.map((topic, index) => renderTopicCard(topic, index))}
							</Row>
						</Card.Body>
					</Card>
				</Tab>
				...
				<Tab eventKey="mqtt-control" title="🎮 MQTT Control Topics">
					<Card className="mb-4">
						...
						<Card.Body>
							...
							<Row>
								{controlTopics.map((topic, index) => renderControlCard(topic, index))}
							</Row>
						</Card.Body>
					</Card>
				</Tab>
				...
				<Tab eventKey="voice-commands" title="🎤 Voice Commands">
					<Card className="mb-4">
						...
						<Card.Body>
							...
							<Row>
								{voiceCommandExamples.map((topic, index) => renderTopicCard(topic, index))}
							</Row>
