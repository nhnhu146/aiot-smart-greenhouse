...
const SettingsPage = () => {
	...
	const checkForChanges = useCallback(() => {
		...
		const alertFrequencyChanged = alertFrequency !== originalAlertFrequency;
		const batchAlertsChanged = batchAlerts !== originalBatchAlerts;

		const hasChanges = thresholdsChanged || emailRecipientsChanged || emailAlertsChanged || alertFrequencyChanged || batchAlertsChanged;
		setHasUnsavedChanges(hasChanges);
		return hasChanges;
	}, [thresholds, originalThresholds, emailRecipients, originalEmailRecipients, emailAlerts, originalEmailAlerts, alertFrequency, originalAlertFrequency, batchAlerts, originalBatchAlerts]);
